...
var VISIBLE_MEMBERS = [
  ...
  },
  {
    ...
    shortBio: "Colin has a background in web development, and works for Strobe writing mobile applications. He has mostly worked on media and publishing apps for iPhone, Android, iPad and desktop. Before joining Strobe in July ’10, he worked in a ",
  ...
  },
  {
    ...
    shortBio: "Evin has been working with Sproutcore ever since he took his job at Eloqua in 2008. Working closely with a large team of developers, Evin was the Technical and Team Lead for developing one of the largest Sproutcore Application at ",
  ...
  },
  {
    ...
    shortBio: "Starting with Eloqua to help build the company’s new Eloqua10 user interface that is entirely based on SproutCore, Michael has been involved with the framework for two years. As a core team member, he is the creator of two ",
  ...
  },
  {
    ...
    shortBio: "Mike has been involved with SproutCore for nearly 3 years. During that period he used SproutCore to transform Eloqua's UX. As a core team member Mike has been primarily involved developing SpoutCore's UI builder Greenhouse and ",
  ...
  },
  {
    ...
    name: "Peter Wagenet",
    location: "",
    shortBio: "Peter Wagenet is a member of the SproutCore Core Team and a SproutCore engineer at Strobe. Prior to working at Strobe, Peter was also a Ruby on Rails engineer and still enjoys tinkering around with it in his free time. His projects can ",
  ...
  },
  {
    ...
    name: "Tom Dale",
    location: "San Francisco, CA, USA",
    shortBio: "Tom graduated from UC Irvine with a degree in criminology in 2008. He built an internal tool for the Apple retail stores in 2009, which was his first time using SproutCore, his first exposure to JavaScript, and his first time meeting",
  ...
  },
  {
    ...
    name: "Yehuda Katz",
    location: "San Francisco, CA, USA",
    shortBio: "Yehuda Katz is a member of the SproutCore, Ruby on Rails and jQuery Core Teams; during the daytime, he works as Chief Technologist at Strobe. Yehuda is the co-author of the best-selling jQuery in Action, the upcoming ",
